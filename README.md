...
- [**📡Сбор данных через API на Python**](https://github.com/Anastasiya-analyst/API-Data-Collection) - проекты по сбору и анализу данных с использованием Python и API различных сервисов


------------
### 🎓 **Подтверждение квалификации**

- [**📜 Образовательные сертификаты и дипломы**](https://github.com/Anastasiya-analyst/diploma-keeper) -  мой академический трек
- [**📋 Рекомендации**](https://github.com/Anastasiya-analyst/diploma-keeper/blob/main/RECOMMENDATIONS.md) -   Рекомендательное письмо
###
------------
